...
public class Room implements AutoCloseable {
    ...
    protected synchronized void roll(ServerThread client) {
    	int result = flipRoll.nextInt(21);
    	sendMessage(client, "<b><i><font color=blue> rolled a " + result + "</font></i></b>");
    }
    ...
    protected synchronized void flip(ServerThread client) {
    	...
    	sendMessage(client, "<b><i><font color=red>" + message + "</font></i></b>");
    }
	...
	try {
		...
		//bold font
		 ...
		 // color font, add color between two pound signs, use null for black
			if (command.matches("(.*)#(.+)#(.*)")) {
				String changeText = "";
